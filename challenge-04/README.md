...
carro.pessoasNoCarro = function(param) {
...
adicionarPessoas(-4); 'Já temos 1 pessoas no carro!'

// Adicione 10 pessoas no carro.
carro.adiicionarPessoas(10); //'Só cabem mais 4 pessoas!'
