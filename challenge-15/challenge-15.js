(function () {
  ...
  */
  ...
  var Gabriel = new Person('Gabriel', 'Amorim', 23);
  var Jorge = new Person('Jorge', 'Tomé', 29);
...
console.log( Gabriel.getFullName(), "tem " + Gabriel.getAge() + " anos." );
  ...
  */
  ...
  console.log( Gabriel.getFullName() + " agora tem " + Gabriel.addAge( 5 ).getAge() + " anos." );
  console.log( Jorge.getFullName() + " agora tem " + Jorge.addAge( 3 ).getAge() + " anos." );
  console.log( Fernando.getFullName() + " agora tem " + Fernando.addAge( -5 ).getAge() + " anos." );
})();